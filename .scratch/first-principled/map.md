...
11. [Deploy to Netlify or Vercel](issues/11-deploy-to-netlify-or-vercel.md) - `ready-for-agent` (was blocked by 10) - Netlify chosen, CLI authed, key in .env; no human gate
