...
- [03 - Concept tree generation with observations](issues/03-concept-tree-generation-with-observations.md) - claimed (opencode session, 2026-08-13), blocked by 02 (resolved)
- [04 - Observation-first tree UI](issues/04-observation-first-tree-ui.md) - ready-for-agent, blocked by 03
- [06 - Apply STE to all learner-facing copy](issues/06-apply-ste-to-all-learner-facing-copy.md) - ready-for-agent, blocked by 03
