// CDP live smoke for v6 ticket 11 against the unique deploy URL.
...
const run = async () => {
  ...
  await shot(page, "11-375-empty.png");
  ...
  await shot(page, "11-375-how.png");
  ...
  await shot(page, "11-375-tree.png");
  ...
  await shot(page, "11-375-panel.png");
