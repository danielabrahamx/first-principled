...
records the 2026-08-18 live gate. DeepSeek rejects `json_schema`.
OpenRouter `:free` cannot constrain. OpenRouter paid Nemotron with the
flattened Stage 2 schema passed `epiphaniesProblems` and Arrange ran.
